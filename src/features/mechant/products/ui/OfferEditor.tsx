import { Stack, TextField, Switch, FormControlLabel, Paper, Typography } from "@mui/material";
...
export default function OfferEditor({ value, onChange }: Props) {
  ...
  return (
    <Paper variant="outlined" sx={{ p: 2 }}>
      <Typography fontWeight={600} mb={1}>العرض الترويجي</Typography>
      <FormControlLabel
        control={<Switch checked={!!v.enabled} onChange={(e) => set({ enabled: e.target.checked })} />}
        label="تفعيل العرض"
      />
      {v.enabled && (
