...
const features = [
  {
    ...
    desc:
      "يرد على عملائك بشكل طبيعي ومخصص حتى باللهجات المحلية، مما يجعل تجربة التواصل أكثر قرباً وسلاسة...",
  ...
  },
  {
    ...
    desc:
      "تحكم كامل في واتساب، تيليجرام، ودردشة الموقع من لوحة واحدة سهلة الاستخدام...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <ThumbUpAltIcon />,
    ...
    desc:
      "كل عميل يحصل على رد يناسب سؤاله مباشرة بدون انتظار، بفضل الذكاء الاصطناعي...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <StoreIcon />,
    ...
    desc:
      "يدعم جميع المنصات الكبرى — سلة، زد، وغيرها — مع خطوات ربط سهلة وسريعة...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <SecurityIcon />,
    title: "أمان وخصوصية",
    desc:
      "بياناتك وبيانات عملائك بأمان تام، وتحكم كامل لك في جميع الإعدادات والصلاحيات...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <QueryStatsIcon />,
    ...
    desc:
      "اكتشف أسئلة واهتمامات عملائك ونمِّ مبيعاتك من خلال تقارير وتحليلات فورية...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <AccessTimeIcon />,
    ...
    desc:
      "كليم يعمل ليل نهار لخدمة عملائك وزيادة مبيعاتك دون توقف...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
  {
    icon: <LanguageIcon />,
    ...
    desc:
      "لوحة تحكم واضحة ودعم كامل للغة العربية، لتتمكن من إدارة جميع مهامك بسهولة...",
    gradient: "linear-gradient(90deg, #7E66AC, #502e91)",
  },
];
...
export default function WhyChooseKaleem() {
  ...
  const totalPages = useMemo(
    () => Math.max(1, Math.ceil(features.length / perView)),
  ...
  const onScroll = () => {
    ...
    const itemWidth = el.scrollWidth / totalPages;
    const currentPage = Math.round(scrollPos / itemWidth);
