...
export default function ProductsPage() {
  ...
  return (
    <Box position="relative" minHeight="100vh" sx={{ p: { xs: 2, md: 4 }, bgcolor: "#f5f5f5" }} dir="rtl">
      <Box display="flex" justifyContent="space-between" alignItems={{ xs: "stretch", sm: "center" }} flexWrap="wrap" gap={1.5} mb={4}>
        <Typography variant="h5" fontWeight={800}>إدارة المنتجات</Typography>
